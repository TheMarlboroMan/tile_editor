...
//!Controller for the thing editor layer properties
class thing_editor_properties:
	public dfw::controller_interface {

	public:

								thing_editor_properties(lm::logger&, ldtools::ttf_manager&, tile_editor::exchange_data&);
