...
class map_loader {
	...
	public:
					        ...
					        map_loader(lm::logger&, tools::message_manager&, const std::map<std::size_t, tile_editor::thing_definition_table>&, const std::map<std::size_t, tile_editor::poly_definition_table>&, const tile_editor::property_table&);
